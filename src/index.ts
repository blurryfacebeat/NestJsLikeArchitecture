...
import { IUsersController } from './modules/users/users.types.js';
import { LoggerService } from './modules/logger/logger.service.js';
import { UsersController } from './modules/users/users.controller.js';
import { IUsersService } from './modules/users/users.service.types.js';
...
const appBindings = new ContainerModule((bind: interfaces.Bind) => {
  ...
  bind<IUsersService>(MODULE_TYPE.UsersService).to(UsersService);
  bind<IUsersController>(MODULE_TYPE.UsersController).to(UsersController);
